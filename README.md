...
1. **Tray icon** — catparty lives in your macOS menu bar. Click to toggle the window; right-click for settings (Always on Top, Launch at Login, Quit).
...
The app runs a local HTTP server on `127.0.0.1:4689` (configurable via `CATPARTY_PORT`).
